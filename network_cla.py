...
def conv_S(in_planes,out_planes,stride=1,padding=1): #inplanes其实就是channel,叫法不同
...
def P3D199(pretrained=False,modality='RGB',**kwargs):
    ...
    if pretrained==True:
        if modality=='RGB':
            pretrained_file='/data1/guoxi/p3d_floder/pretrained_file/p3d_rgb_199.checkpoint.pth.tar'
        elif modality=='Flow':
            pretrained_file='/data1/guoxi/p3d_floder/pretrained_file/p3d_flow_199.checkpoint.pth.tar'
