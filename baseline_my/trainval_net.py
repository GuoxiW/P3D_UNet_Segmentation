...
def train_net(tcnn_model, dataloader, optimizer, args):
    ...
    for step, (video_data, gt_twins, num_gt) in enumerate(dataloader):
        ...
        optimizer.zero_grad()
        loss.backward()
        # if args.net == "vgg16": clip_gradient(tcnn_model, 100.)
        optimizer.step()
...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        tcnn_model.load_state_dict(checkpoint['model'])
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        if len(args.gpus) > 1:
            ...
            save_checkpoint({
                ...
                'epoch': epoch,
                'model': tcnn_model.module.state_dict(),
