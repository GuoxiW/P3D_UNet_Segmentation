...
def main():
    ...
    train_data = dataset.get_training_set(opt, reference_path, spatial_transform, target_transform, RandomCrop_transform, RandomHorizontalFlip_transform, RandomErase_transform)
    ...
    validation_data = dataset.get_validation_set(opt, reference_path, spatial_transform, target_transform, None, None, None)
